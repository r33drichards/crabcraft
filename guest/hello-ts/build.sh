#!/usr/bin/env bash
# Build the hello-ts reactor module (scaffolded by crabgen; edit freely — this
...
disasm="$(nix shell nixpkgs#wabt --command wasm-objdump -d ../../modules/hello-ts.wasm)"
