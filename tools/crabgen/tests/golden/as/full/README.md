# full — crabcraft guest (AssemblyScript lane)

<!-- generated by crabgen — edits will be overwritten on regen -->

Generated by crabgen. `full.wit` is the source of truth; `gen/`,
...
asc (via nix's nodejs) builds a wasm REACTOR at `../../modules/full.wasm`
...
1. Edit `full.wit`.
2. `crabgen regen guest/full` — rewrites the generated files and prints
