(() => {
  ...
  var send = (cmd) => console.log("CRB " + JSON.stringify(cmd));
  var btn = (bg) => ({ background: bg, color: "white" });
  function Prompt({ title, note, onCancel }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { color: "yellow", textAlign: "center" }, children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "gray" }, children: note || "\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: onCancel, style: btn("gray"), children: "[ Cancel ]" })
    ] });
  }
  function CardApp() {
    const [s, setS] = (0, import_react.useState)({ screen: "locked", note: "" });
    ...
    const cancel = () => {
      send({ op: "cancel" });
      setS({ screen: "locked", note: "" });
    };
    switch (s.screen) {
      case "awaitcard":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Prompt, { title: "Tap your card", note: s.note, onCancel: cancel });
      case "enrolling":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Prompt, { title: "Enrolling\u2026", note: s.note, onCancel: cancel });
      case "unlocked":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { color: "lime", textAlign: "center" }, children: "UNLOCKED" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
            "Welcome, ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: { color: "cyan" }, children: s.user }),
            s.role ? " (" + s.role + ")" : ""
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => send({ op: "opendoor" }), style: btn("green"), children: "[ Open Door ]" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            send({ op: "lock" });
            setS({ screen: "locked", note: "" });
          }, style: btn("gray"), children: "[ Lock ]" })
        ] });
      case "denied":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { color: "red", textAlign: "center" }, children: "DENIED" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "red" }, children: s.note }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            send({ op: "lock" });
            setS({ screen: "locked", note: "" });
          }, style: btn("gray"), children: "[ Back ]" })
        ] });
      case "enrolled":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { color: "lime", textAlign: "center" }, children: "ENROLLED" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
            s.user,
            " \u2014 user_id ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: { color: "yellow" }, children: s.id })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "gray" }, children: "Card written. Keep the floppy safe." }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            send({ op: "lock" });
            setS({ screen: "locked", note: "" });
          }, style: btn("gray"), children: "[ Back ]" })
      ...
      default:
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { color: "white", textAlign: "center" }, children: "\u{1F512} LOCKED" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            send({ op: "signin" });
            setS({ screen: "awaitcard", note: "" });
          }, style: btn("blue"), children: "[ Sign in ]" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            send({ op: "signup" });
            setS({ screen: "enrolling", note: "" });
          }, style: btn("green"), children: "[ Sign up ]" })
        ] });
    }
  }
  ...
  reconciler.flushSync(() => {
    reconciler.updateContainer(import_react2.default.createElement(CardApp), container, null, null);
  });
